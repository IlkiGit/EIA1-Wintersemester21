...
/* Karten werden als Objekt deklariert */
...
for (let i = 0; i < symbole.length; i++) 
{
    ...
    {
        let karte: Karten = {wert: werte[x], symbol: symbole[i]};
        deck.push(karte);
    }
}
/* Deck wird gemischt */
...
window.addEventListener("load", function(): void
{
    ...
    function kartenErstellen ()
    {
        ...
        let ablagecard: HTMLParagraphElement = document.createElement("div");
        let ablagewert: HTMLParagraphElement = document.createElement("p");
    ...
    function zugBeenden ()
    {
        ...
        {
            let spielerText: HTMLParagraphElement = document.createElement("p");
        ...
        {
            let computerText: HTMLParagraphElement = document.createElement("p");
